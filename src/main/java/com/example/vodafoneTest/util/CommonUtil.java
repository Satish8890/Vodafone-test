...
public class CommonUtil {
	...
	public static String getStatus(CSVFileDetails deviceInfo) {
	...
	public static String getStatus(List<CSVFileDetails> dlist) {
	...
	public static String getBatteryStatus(CSVFileDetails deviceInfo) {
	...
	public static String getDescription(CSVFileDetails csvFileDetails) {

		if (csvFileDetails != null && csvFileDetails.getAirplaneMode() != null
				&& csvFileDetails.getAirplaneMode().equals("OFF")) {
	...
	public static String getLatitude(CSVFileDetails csvFileDetails) {

		if (csvFileDetails != null && csvFileDetails.getLatitude() != null
				&& csvFileDetails.getAirplaneMode().equals("OFF")) {

			return csvFileDetails.getLatitude().toString();
		}

		return "";
	}

	public static String getLongitude(CSVFileDetails csvFileDetails) {

		if (csvFileDetails != null && csvFileDetails.getLongitude() != null
				&& csvFileDetails.getAirplaneMode().equals("OFF")) {

			return csvFileDetails.getLongitude().toString();
		}
